...
const Home = () => {
	...
	const postSubmit = async (e) => {
		...
		if (content=="<p><br></p>") toast.error("Put some description of post.");
		else {
			try {
            ...
            <h1>Newsfeed</h1>
				...
				<div className="row py-3">
					<div className="col-md-8">
						...
						{posts.length == 0 ? (
							<h3
								...
								No posts to show !<br /> Follow Users to see
								their post
							</h3>
						) : (
							<PostList
					...
					<div className="col-md-4 ">
						...
						<br />
						<br />
						<Search newsFeed={newsFeed} findPeople={findPeople} />
						<h4>Users you may follow: </h4>
						<People
							people={people}
